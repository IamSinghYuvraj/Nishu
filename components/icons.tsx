...
export const Cog = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
...
export const Shield = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 12l2 2m4-4l2 2m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"
    />
  </svg>
)
...
export const Phone = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3 5a2 2 0 012-2h3.28a1 1 0 00.948.684l1.498 4.493a1 1 0 00.502.756l2.048 1.029c.393-.337.808-.577 1.224-.577.516 0 .996.164 1.423.447l2.048-1.029a1 1 0 00.502-.756l1.498-4.493a1 1 0 00-.948-.684H19a2 2 0 00-2 2v12a2 2 0 002 2h4a2 2 0 002-2V5a2 2 0 00-2-2h-2.5a.5.5 0 00-.5.5v2a.5.5 0 01-.5.5H8a.5.5 0 01-.5-.5v-2a.5.5 0 00-.5-.5H5a2 2 0 00-2 2v12a2 2 0 002 2h4a2 2 0 002-2V5z"
    />
  </svg>
)
...
export const Leaf = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1m2-1v2.5m0 0l-2 1m2-1l2 1m-2 1v2.5m-2-2l-2-1-2 1m2-1v2.5m0 0l2 1m-2-1l-2 1"
    />
  </svg>
)
